...
namespace auto_aim
{
Plan Planner::plan(auto_aim_eskf::Target target, double bullet_speed)
{
...
Plan Planner::plan(std::optional<auto_aim_eskf::Target> target, double bullet_speed)
{
...
Eigen::Matrix<double, 2, 1> Planner::aim(
  const auto_aim_eskf::Target & target, double bullet_speed)
{
  Eigen::Vector3d xyz;
  double yaw;
  auto min_dist = 1e10;
...
Trajectory Planner::get_trajectory(
  auto_aim_eskf::Target & target, double yaw0, double bullet_speed)
{
  Trajectory traj;
